...
from mailings.views import (
    ...
    RecipientClientListView,
    RecipientClientUpdateView,
    RecipientClientDetailView,
    RecipientClientDeleteView,
    RecipientClientCreateView,
    MailingHistoryListView,
    MailingHistoryDetailView,
...
urlpatterns = [
    ...
    path(
        "clients_update/<int:pk>",
        RecipientClientUpdateView.as_view(),
        name="clients_update",
    ),
    ...
    path(
        "clients_detail/<int:pk>",
        RecipientClientDetailView.as_view(),
        name="clients_detail",
    ),
    path(
        "history_detail/<int:pk>",
        MailingHistoryDetailView.as_view(),
        name="history_detail",
    ),
    ...
    path(
        "clients_delete/<int:pk>",
        RecipientClientDeleteView.as_view(),
        name="clients_delete",
    ),
    path(
        "history_delete/<int:pk>",
        MailingHistoryDeleteView.as_view(),
        name="history_delete",
    ),
